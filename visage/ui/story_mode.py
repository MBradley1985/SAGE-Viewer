...
from visage.story import discover_stories, load_story
...
def init_story_mode(server, scene) -> StoryPlayer:
    ...
    state.story_list = []
    # Overlays are shipped as JSON and rendered by visage.js OUTSIDE Vue
...
def build_story_overlays(server) -> None:
    ...
    auto-render (``visage.js`` watches this container for changes).
    """
    # Empty container — Vue owns the element but NOT its children, which
    # visage.js builds from story_overlays_json and typesets with KaTeX.
    ...
    html.Div(
        ...
        # authored against. visage.js builds a #sage-overlay-stage of
    ...
    # Scene-selector relay: visage.js writes the clicked cell's index here
