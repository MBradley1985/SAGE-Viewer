...
def build_navigation_panel(server, scene: Scene) -> None:
    """Navigation controls rendered inside a fixed-width right column."""
    ...
    def on_go_to_coords():
        ...
        state.nav_status = (
            f"Camera → ({state.nav_x:.1f}, {state.nav_y:.1f}, {state.nav_z:.1f})"
        )
    ...
    with v3.VList(density="compact", style="background:transparent;"):
        v3.VListSubheader("NAVIGATION", style="color:#06b6d4; font-weight:700;")
        ...
        v3.VDivider(style="margin:6px 0;")
        v3.VListSubheader("Fly to Halo", style="color:#9ca3af;")
        with v3.VListItem():
            v3.VTextField(
        ...
        v3.VDivider(style="margin:6px 0;")
        v3.VListSubheader("Fly to Galaxy", style="color:#9ca3af;")
        with v3.VListItem():
            v3.VTextField(
                v_model=("nav_gal_idx",),
                label="Galaxy index",
        ...
        v3.VDivider(style="margin:6px 0;")
        v3.VListSubheader("Fly to Coordinates", style="color:#9ca3af;")
        ...
        v3.VDivider(style="margin:6px 0;")
        v3.VListSubheader("Zoom to Sub-box", style="color:#9ca3af;")
        for label, key in [
